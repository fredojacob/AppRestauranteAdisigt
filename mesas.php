...
<button type="button" class="close" data-dismiss="modal" aria-hidden="true"><img src="assets/images/close.png"/></button> 
         <h3 class="panel-title"><i class="fa fa-align-justify"></i> Datos de Mesa</h3> 
                                                        </div> 
                                                        <div class="panel-body"> 
                                                         <div id="muestramesamodal"></div>
                                                        </div>
...
<div class="row">
<div class="col-sm-12">
<div class="page-header-title"><h4 class="pull-left page-title"><i class="fa fa-tasks"></i> Control de Mesas</h4>
<ol class="breadcrumb pull-right"><li><a href="panel">Inicio</a></li>
<li class="active">Control de Mesas</li>
</ol>
...
<div class="panel-heading">
<h3 class="panel-title"><i class="fa fa-tasks"></i> Mesas<span class="pull-right"><a href="formesa" class="btn btn-default dropdown-toggle" data-toggle="tooltip" data-placement="left" title="" data-original-title="Nueva Mesa"><span class="fa fa-plus"></span> Nueva</a></span></h3></div>
		...
		if(isset($_GET["mesage"]))
{
	switch($_GET["mesage"])
	{
		...
		echo "<center><span class='fa fa-check-square-o'></span> LA MESA DE SALA FUE ELIMINADA EXITOSAMENTE </center>"; 
        echo "</div>"; 
		break;
		...
		echo "<button type='button' class='close' data-dismiss='alert' aria-hidden='true'>&times;</button>";
		echo "<center><span class='fa fa-info-circle'></span> ESTA MESA DE SALA NO PUEDE SER ELIMINADA, TIENE VENTAS ASOCIADAS ACTUALMENTE </center>";
        echo "</div>";   
		break;
...
?>
                                   ...
                                   <td><?php echo $status = ( $reg[$i]['statusmesa'] == '0' ? "<span class='label label-success'><i class='fa fa-check'></i> DISPONIBLE</span>" : "<span class='label label-warning'><i class='fa fa-times'></i> RESERVADA</span>"); ?></td>
                                              <td><?php echo $reg[$i]['mesacreada']; ?></td>
											   <td>
 
 <a href="#" class="btn btn-success btn-xs" data-placement="left" title="Ver Mesa" data-original-title="" data-href="#" data-toggle="modal" data-target="#panel-modal" data-backdrop="static" data-keyboard="false" onClick="VerMesa('<?php echo base64_encode($reg[$i]["codmesa"]); ?>')"><i class="fa fa-search-plus"></i></a>
								  
<a href="#" class="btn btn-primary btn-xs" data-toggle="tooltip" data-placement="left" title="" data-original-title="Editar Mesa" onClick="actualizar('formesa?codmesa=<?php echo base64_encode($reg[$i]["codmesa"]) ?>')"><i class="fa fa-pencil"></i></a>
                                 
<a href="#" class="btn btn-danger btn-xs" data-toggle="tooltip" data-placement="left" title="" data-original-title="Eliminar Mesa" onClick="eliminar('eliminar?<?php echo base64_encode('eliminar'); ?>&codmesa=<?php echo base64_encode($reg[$i]["codmesa"]) ?>&tipo=<?php echo base64_encode("MESAS") ?>')"><i class="fa fa-trash-o"></i></a> </td>
											   </tr>
											   <?php } } ?>
											   </tbody>
</table>
